...
const allItems = {
  ...
  setlist:          { label: 'Setlist / SAMRO',        href: '/programming/setlist',       icon: Mic2 },
  coproduction:     { label: 'Co-Productions',         href: '/programming/coproduction',  icon: Handshake },
  rentalBookings:   { label: 'Rental Bookings',        href: '/structure/rentals/bookings', icon: CreditCard },
